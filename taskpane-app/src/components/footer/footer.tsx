...
import { Link, Popover, PopoverTrigger, PopoverSurface } from '@fluentui/react-components';
...
export function GithubFooter() {
  ...
  return (
    <div className={styles.footer}>
      ...
      <Link data-testid='contribute-github-button' as="button" onClick={openGithub}>Contribute here</Link>
    </div>
  );
}