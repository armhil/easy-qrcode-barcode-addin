...
export function CreditsTab() {
  ...
  return (
    <>
      <p>
        This software wouldn't be possible without components below and
        countless hours of learning and coding.
      </p>
      <ul>
        <li>
          <a
        ...
        <li>
          <a
            ...
            rel="noreferrer"
          >
            Zpao's React QR Code Generator
          </a>
        </li>
        <li>
          <a
            href="https://github.com/kciter/react-barcode"
            target="_blank"
            rel="noreferrer"
          >
            Kciter's React Barcode Generator
          </a>
        </li>
      </ul>
    </>
